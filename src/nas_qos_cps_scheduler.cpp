                                        ...
                                        nas_qos_scheduler * scheduler)
{
    ...
    cps_api_object_attr_add(ret_obj, BASE_QOS_SCHEDULER_PROFILE_NAME,
                scheduler->get_name(), SCHEDULER_PROFILE_NAME_LEN);
                                ...
                                cps_api_object_list_t sav_obj)
{
    ...
    if (scheduler_attr == NULL) {
        EV_LOGGING(QOS, DEBUG, "NAS-QOS", " scheduler id not specified in the message\n");
