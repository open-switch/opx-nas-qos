        ...
        _yang_qos_map_obj_map = {
                ...
                {NDI_QOS_MAP_DOT1P_TO_COLOR,
                    {BASE_QOS_DOT1P_TO_COLOR_MAP_OBJ,
                     ...
                     BASE_QOS_DOT1P_TO_COLOR_MAP_NAME,
                     //keys
                ...
                {NDI_QOS_MAP_DSCP_TO_COLOR,
                    {BASE_QOS_DSCP_TO_COLOR_MAP_OBJ,
                     ...
                     BASE_QOS_DSCP_TO_COLOR_MAP_NAME,
                     //keys
                ...
                {NDI_QOS_MAP_TC_COLOR_TO_DOT1P,
                    {BASE_QOS_TC_COLOR_TO_DOT1P_MAP_OBJ,
                     ...
                     BASE_QOS_TC_COLOR_TO_DOT1P_MAP_NAME,
                     //keys
                ...
                {NDI_QOS_MAP_TC_COLOR_TO_DSCP,
                    {BASE_QOS_TC_COLOR_TO_DSCP_MAP_OBJ,
                     ...
                     BASE_QOS_TC_COLOR_TO_DSCP_MAP_NAME,
                     //keys
                ...
                {NDI_QOS_MAP_TC_TO_PG,
                    {BASE_QOS_TC_TO_PRIORITY_GROUP_MAP_OBJ,
                     ...
                     BASE_QOS_TC_TO_PRIORITY_GROUP_MAP_NAME,
                     //keys
                ...
                {NDI_QOS_MAP_PG_TO_PFC,
                    {BASE_QOS_PRIORITY_GROUP_TO_PFC_PRIORITY_MAP_OBJ,
                     ...
                     BASE_QOS_PRIORITY_GROUP_TO_PFC_PRIORITY_MAP_NAME,
                     //keys
                ...
                {NDI_QOS_MAP_PFC_TO_QUEUE,
                    {BASE_QOS_PFC_PRIORITY_TO_QUEUE_MAP_OBJ,
                     ...
                     BASE_QOS_PFC_PRIORITY_TO_QUEUE_MAP_NAME,
                     //keys
...
nas_attr_id_t qos_map_map_name_obj_id(nas_qos_map_type_t type)
{
    return _yang_qos_map_obj_map.at(type).map_name_obj;
}
                                        ...
                                        nas_obj_id_t &map_id)
{
    ...
    try {
        ...
        if (map_attr == NULL) {
            EV_LOGGING(QOS, DEBUG, "NAS-QOS", "map id not specified\n");
            return cps_api_ret_code_ERR;
        }
                                                ...
                                                nas_qos_map_entry_key_t &key)
{
    ...
    try {
        ...
        if (entry_key_attr == NULL) {
            EV_LOGGING(QOS, DEBUG, "NAS-QOS", "map entry key not specified\n");
            return cps_api_ret_code_ERR;
        }
        ...
        case NDI_QOS_MAP_TC_COLOR_TO_DSCP:
        {
            ...
            if (entry_key2_attr == NULL) {
                EV_LOGGING(QOS, DEBUG, "NAS-QOS", "map entry key 2 not specified\n");
                return cps_api_ret_code_ERR;
            }
