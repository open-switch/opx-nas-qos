...
cps_api_return_code_t nas_qos_cps_api_read (void * context,
                                            ...
                                            size_t ix)
{
    EV_LOGGING(QOS, DEBUG, "NAS-QOS", "nas_qos_cps_api_read...");
                                                ...
                                                size_t ix)
{
    ...
    case BASE_QOS_QUEUE_STAT_OBJ:
        EV_LOGGING(QOS, DEBUG, "NAS-QOS", "BASE_QOS_QUEUE_STAT_OBJ Rollback is not supported");
        return NAS_QOS_E_UNSUPPORTED;
