...
public:
    ...
    nas_qos_map (nas_qos_switch* p_switch, nas_qos_map_type_t val);
    ...
    const char * get_name() const {return map_name;}
    void set_name(const char *str)  {
        strncpy(map_name, str, sizeof(map_name));
        map_name[MAP_NAME_LEN-1]=0;
    }
