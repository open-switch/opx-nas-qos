...
#define SCHEDULER_PROFILE_NAME_LEN 32
...
class nas_qos_scheduler : public nas::base_obj_t
{
    ...
    char profile_name[SCHEDULER_PROFILE_NAME_LEN]; // name string of the scheduler profile
...
public:
    ...
    const char * get_name() const {return profile_name;}
    void set_name(const char *str)  {
        strncpy(profile_name, str, sizeof(profile_name));
        profile_name[SCHEDULER_PROFILE_NAME_LEN-1]=0;
    }
